...
var accordion = function accordion(triggersSelector, itemsSelector) {
  var btns = document.querySelectorAll(triggersSelector),
      blocks = document.querySelectorAll(itemsSelector); // btns.forEach((item) => {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windowWithAttr.forEach(function (item) {
...
var pictureSize = function pictureSize(imgSelector) {
  var imgItems = document.querySelectorAll(imgSelector);
  ...
  imgItems.forEach(function (block) {
